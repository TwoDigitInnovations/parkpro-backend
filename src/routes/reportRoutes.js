...
const { createReport, getReport, updateVerifyandSuspendStatus,getReportForGuard,getReportHistory,updatereportstatus,getReportforuser } = require('@controllers/reportController');
...
router.get('/getReportforuser', auth('user', 'admin', 'guard', 'org', 'tech'), getReportforuser);
